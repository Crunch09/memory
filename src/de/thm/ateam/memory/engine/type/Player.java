...
public class Player {
	 ...
	 * geh쉜en aber unter Android spart man sich oft die Methodenaufrufe
	 * aus Geschwindigkeitsgr웢den.
	...
	/**
	 * updatePlayer ver채ndert die Angaben des Spielers in der Datenbank.
	 * 
	 * @param nick - neuer nick, wenn nick == null, wird dieser nicht ver채ndert
	 ...
	 * @param shot - Anzahl der gesamten Kartenz체ge
	 */
	...
	/**
	 * getNick gibt den Nick des jeweiligen Spielers zur체ck.
	 * 
	...
	/**
	 * getWin gibt die Anzahl der Siege des Spielers zur체ck.
	 * 
	...
	/**
	 * getLose gibt die Anzahl der Niederlagen des Spielers zur체ck.
	 * 
	...
	/**
	 * getDraw gibt die Anzahl der Unentschieden des Spielers zur체ck.
	 * 
	...
	/**
	 * getShots die Anzahl aller Kartenz체ge zur체ck.
	 * 
	 * @return int Anzahl aller Kartenz체ge
	 */
	...
	/**
	 * getGameNumber gibt die Anzahl der getroffenen Kartenpaaren zur체ck.
	 * 
	...
	/**
	 * getID gibt die ID des Spielers zur체ck
	 * 
	 ...
	 * der Nick 'null' oder ein leerer String sein, wird stattdessen 0 gew채hlt.
	 * 
